...
\bibitem{rif5} \emph{https://play.google.com/store/apps/details?id=lv.n3o.shark}
\bibitem{rif6} \emph{http://www.wireshark.org}
\bibitem{rif7} \emph{http://packages.ubuntu.com/precise/whois}
\bibitem{rif8} \emph{http://cloudmonitor.ca.com/it/ping.php}
\end{thebibliography}
\end{document}
