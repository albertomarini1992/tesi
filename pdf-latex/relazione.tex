...
La \figurename  2.1 illustra tale funzionamento.
...
L'interfaccia grafica di Wireshark (\figurename  2.2) mostra il numero di pacchetti catturati, il tempo trascorso tra la cattura dei pacchetti, l'indirizzo sorgente e quello di destinazione, il protocollo usato, la lunghezza del pacchetto ed altre informazioni.
